...
public final class DisplayImageOptions {
	...
	private final cc.zhipu.library.imageloader.core.process.BitmapProcessor preProcessor;
	private final cc.zhipu.library.imageloader.core.process.BitmapProcessor postProcessor;
	...
	public cc.zhipu.library.imageloader.core.process.BitmapProcessor getPreProcessor() {
		return preProcessor;
	}

	public cc.zhipu.library.imageloader.core.process.BitmapProcessor getPostProcessor() {
	...
	public static class Builder {
		...
		private cc.zhipu.library.imageloader.core.process.BitmapProcessor preProcessor = null;
		private cc.zhipu.library.imageloader.core.process.BitmapProcessor postProcessor = null;
		 ...
		 */
		public Builder preProcessor(cc.zhipu.library.imageloader.core.process.BitmapProcessor preProcessor) {
		 ...
		 */
		public Builder postProcessor(cc.zhipu.library.imageloader.core.process.BitmapProcessor postProcessor) {
		...
		/**
		 * Sets custom {@linkplain Handler handler} for displaying images and firing {@linkplain cc.zhipu.library.imageloader.core.listener.ImageLoadingListener
		 * listener} events.
		 */
