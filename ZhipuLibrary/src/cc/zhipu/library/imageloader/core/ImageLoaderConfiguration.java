...
import cc.zhipu.library.imageloader.cache.disc.impl.ext.LruDiskCache;
import cc.zhipu.library.imageloader.cache.memory.impl.LruMemoryCache;
 ...
 * @see ImageLoader
 * @see cc.zhipu.library.imageloader.cache.memory.MemoryCache
 * @see cc.zhipu.library.imageloader.cache.disc.DiskCache
 * @see DisplayImageOptions
 * @see cc.zhipu.library.imageloader.core.download.ImageDownloader
 * @see cc.zhipu.library.imageloader.cache.disc.naming.FileNameGenerator
 * @since 1.0.0
 */
public final class ImageLoaderConfiguration {
	...
	final cc.zhipu.library.imageloader.core.process.BitmapProcessor processorForDiskCache;
	...
	final cc.zhipu.library.imageloader.core.assist.QueueProcessingType tasksProcessingType;

	final cc.zhipu.library.imageloader.cache.memory.MemoryCache memoryCache;
	final cc.zhipu.library.imageloader.cache.disc.DiskCache diskCache;
	final cc.zhipu.library.imageloader.core.download.ImageDownloader downloader;
	final cc.zhipu.library.imageloader.core.decode.ImageDecoder decoder;
	final DisplayImageOptions defaultDisplayImageOptions;

	final cc.zhipu.library.imageloader.core.download.ImageDownloader networkDeniedDownloader;
	final cc.zhipu.library.imageloader.core.download.ImageDownloader slowNetworkDownloader;
	...
	private ImageLoaderConfiguration(final Builder builder) {
		...
		LogUtils.writeDebugLogs(builder.writeLogs);
	}
	 ...
	 * <li>tasksProcessingOrder = {@link cc.zhipu.library.imageloader.core.assist.QueueProcessingType#FIFO}</li>
	...
	cc.zhipu.library.imageloader.core.assist.ImageSize getMaxImageSize() {
		...
		return new cc.zhipu.library.imageloader.core.assist.ImageSize(width, height);
	}
	...
	public static class Builder {
		...
		/** {@value} */
		public static final cc.zhipu.library.imageloader.core.assist.QueueProcessingType DEFAULT_TASK_PROCESSING_TYPE = cc.zhipu.library.imageloader.core.assist.QueueProcessingType.FIFO;
		...
		private cc.zhipu.library.imageloader.core.process.BitmapProcessor processorForDiskCache = null;
		...
		private cc.zhipu.library.imageloader.core.assist.QueueProcessingType tasksProcessingType = DEFAULT_TASK_PROCESSING_TYPE;

		private int memoryCacheSize = 0;
		private long diskCacheSize = 0;
		private int diskCacheFileCount = 0;

		private cc.zhipu.library.imageloader.cache.memory.MemoryCache memoryCache = null;
		private cc.zhipu.library.imageloader.cache.disc.DiskCache diskCache = null;
		private cc.zhipu.library.imageloader.cache.disc.naming.FileNameGenerator diskCacheFileNameGenerator = null;
		private cc.zhipu.library.imageloader.core.download.ImageDownloader downloader = null;
		private cc.zhipu.library.imageloader.core.decode.ImageDecoder decoder;
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, cc.zhipu.library.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		public Builder discCacheExtraOptions(int maxImageWidthForDiskCache, int maxImageHeightForDiskCache,
				cc.zhipu.library.imageloader.core.process.BitmapProcessor processorForDiskCache) {
		 ...
		 * @param processorForDiskCache      null-ok; {@linkplain cc.zhipu.library.imageloader.core.process.BitmapProcessor Bitmap processor} which process images before saving them in disc cache
		 */
		 ...
		 * <li>{@link #tasksProcessingOrder(cc.zhipu.library.imageloader.core.assist.QueueProcessingType)}</li>
		 * </ul>
		 *
		 ...
		 * Default value - {@link cc.zhipu.library.imageloader.core.assist.QueueProcessingType#FIFO}
		 */
		public Builder tasksProcessingOrder(cc.zhipu.library.imageloader.core.assist.QueueProcessingType tasksProcessingType) {
			if (taskExecutor != null || taskExecutorForCachedImages != null) {
				LogUtils.w(WARNING_OVERLAP_EXECUTOR);
			}
		 ...
		 * memory cache. You can use {@link #memoryCache(cc.zhipu.library.imageloader.cache.memory.MemoryCache)} method to set your own implementation of
		 * {@link cc.zhipu.library.imageloader.cache.memory.MemoryCache}.
		 */
		 ...
		 * </ul>
		 */
		public Builder memoryCache(cc.zhipu.library.imageloader.cache.memory.MemoryCache memoryCache) {
		 ...
		 * will be used as disk cache. You can use {@link #diskCache(cc.zhipu.library.imageloader.cache.disc.DiskCache)} method for introduction your own
		 * implementation of {@link cc.zhipu.library.imageloader.cache.disc.DiskCache}
		 */
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(cc.zhipu.library.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		public Builder discCacheFileNameGenerator(cc.zhipu.library.imageloader.cache.disc.naming.FileNameGenerator fileNameGenerator) {
		 ...
		 */
		public Builder diskCacheFileNameGenerator(cc.zhipu.library.imageloader.cache.disc.naming.FileNameGenerator fileNameGenerator) {
			if (diskCache != null) {
		...
		/** @deprecated Use {@link #diskCache(cc.zhipu.library.imageloader.cache.disc.DiskCache)} */
		@Deprecated
		public Builder discCache(cc.zhipu.library.imageloader.cache.disc.DiskCache diskCache) {
		 ...
		 * <li>{@link #diskCacheFileNameGenerator(cc.zhipu.library.imageloader.cache.disc.naming.FileNameGenerator)}</li>
		 * </ul>
		 */
		public Builder diskCache(cc.zhipu.library.imageloader.cache.disc.DiskCache diskCache) {
		 ...
		 */
		public Builder imageDownloader(cc.zhipu.library.imageloader.core.download.ImageDownloader imageDownloader) {
		 ...
		 */
		public Builder imageDecoder(cc.zhipu.library.imageloader.core.decode.ImageDecoder imageDecoder) {
		 ...
		 * Consider {@link LogUtils#disableLogging()} to disable
		...
		private void initEmptyFieldsWithDefaultValues() {
			...
			if (denyCacheImageMultipleSizesInMemory) {
				memoryCache = new cc.zhipu.library.imageloader.cache.memory.impl.FuzzyKeyMemoryCache(memoryCache, cc.zhipu.library.imageloader.utils.MemoryCacheUtils.createFuzzyKeyComparator());
			}
			if (downloader == null) {
	 ...
	 * @since 1.8.0
	 */
	private static class NetworkDeniedImageDownloader implements cc.zhipu.library.imageloader.core.download.ImageDownloader {

		private final cc.zhipu.library.imageloader.core.download.ImageDownloader wrappedDownloader;

		public NetworkDeniedImageDownloader(cc.zhipu.library.imageloader.core.download.ImageDownloader wrappedDownloader) {
	 ...
	 * using {@link cc.zhipu.library.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
	private static class SlowNetworkImageDownloader implements cc.zhipu.library.imageloader.core.download.ImageDownloader {

		private final cc.zhipu.library.imageloader.core.download.ImageDownloader wrappedDownloader;

		public SlowNetworkImageDownloader(cc.zhipu.library.imageloader.core.download.ImageDownloader wrappedDownloader) {
			this.wrappedDownloader = wrappedDownloader;
		}
		...
		public InputStream getStream(String imageUri, Object extra) throws IOException {
			...
			switch (Scheme.ofUri(imageUri)) {
				case HTTP:
				case HTTPS:
					return new cc.zhipu.library.imageloader.core.assist.FlushedInputStream(imageStream);
				default:
					return imageStream;
			}
		}
