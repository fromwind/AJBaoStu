 ...
 *******************************************************************************/
package cc.zhipu.library.imageloader.core.imageaware;
...
import cc.zhipu.library.imageloader.core.listener.ImageLoadingListener;
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain cc.zhipu.library.imageloader.core.assist.ViewScaleType scale type} which is used for
	 * scaling image for this image aware view. Must <b>NOT</b> return <b>null</b>.
	 */
	cc.zhipu.library.imageloader.core.assist.ViewScaleType getScaleType();
