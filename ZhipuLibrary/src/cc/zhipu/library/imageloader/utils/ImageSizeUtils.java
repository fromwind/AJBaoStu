 ...
 *******************************************************************************/
package cc.zhipu.library.imageloader.utils;
...
public final class ImageSizeUtils {
	...
	private static cc.zhipu.library.imageloader.core.assist.ImageSize maxBitmapSize;

	static {
		int[] maxTextureSize = new int[1];
		GLES10.glGetIntegerv(GL10.GL_MAX_TEXTURE_SIZE, maxTextureSize, 0);
		int maxBitmapDimension = Math.max(maxTextureSize[0], DEFAULT_MAX_BITMAP_DIMENSION);
		maxBitmapSize = new cc.zhipu.library.imageloader.core.assist.ImageSize(maxBitmapDimension, maxBitmapDimension);
	}
	 ...
	 */
	public static cc.zhipu.library.imageloader.core.assist.ImageSize defineTargetSizeForView(ImageAware imageAware, cc.zhipu.library.imageloader.core.assist.ImageSize maxImageSize) {
	 ...
	 */
	public static int computeImageSampleSize(cc.zhipu.library.imageloader.core.assist.ImageSize srcSize, cc.zhipu.library.imageloader.core.assist.ImageSize targetSize, ViewScaleType viewScaleType,
	 ...
	 */
	public static int computeMinImageSampleSize(cc.zhipu.library.imageloader.core.assist.ImageSize srcSize) {
		final int srcWidth = srcSize.getWidth();
		final int srcHeight = srcSize.getHeight();
	 ...
	 */
	public static float computeImageScale(cc.zhipu.library.imageloader.core.assist.ImageSize srcSize, cc.zhipu.library.imageloader.core.assist.ImageSize targetSize, ViewScaleType viewScaleType,
			boolean stretch) {
		final int srcWidth = srcSize.getWidth();
		final int srcHeight = srcSize.getHeight();
		final int targetWidth = targetSize.getWidth();
