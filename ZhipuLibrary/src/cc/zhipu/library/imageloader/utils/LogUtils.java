...
public final class LogUtils {
	...
	/**
	 * Enables/disables detail logging of {@link cc.zhipu.library.imageloader.core.ImageLoader} work.
	...
	/** Enables/disables logging of {@link cc.zhipu.library.imageloader.core.ImageLoader} completely (even error logs). */
	...
	private static void log(int priority, Throwable ex, String message, Object... args) {
		...
		Log.println(priority, cc.zhipu.library.imageloader.core.ImageLoader.TAG, log);
	}
}