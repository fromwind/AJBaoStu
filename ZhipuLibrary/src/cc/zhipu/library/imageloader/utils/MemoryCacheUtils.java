...
public final class MemoryCacheUtils {
	 ...
	 */
	public static List<Bitmap> findCachedBitmapsForImageUri(String imageUri, cc.zhipu.library.imageloader.cache.memory.MemoryCache memoryCache) {
	 ...
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain ImageLoaderConfiguration configuration}
	 */
	public static List<String> findCacheKeysForImageUri(String imageUri, cc.zhipu.library.imageloader.cache.memory.MemoryCache memoryCache) {
	 ...
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain ImageLoaderConfiguration configuration}
	 */
	public static void removeFromCache(String imageUri, cc.zhipu.library.imageloader.cache.memory.MemoryCache memoryCache) {
