...
//	private TextView mRefreshTimeView;
	...
	private void initView() {
		...
		mContainer.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
				0));
		mContainer.findViewById(R.id.refreshable_list_head_content_layoput)
				.getLayoutParams().height = Helper.dip2px(getContext(), 50);
		mContainer.findViewById(R.id.refreshable_list_head_content_layoput)
				.requestLayout();
		...
		mRefreshArrowView.getLayoutParams().height = Helper.dip2px(
				getContext(), 46);
		mRefreshArrowView.getLayoutParams().width = Helper.dip2px(getContext(),
				32);
...
//		mRefreshTimeView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 14);
		...
		mProgressBar.getLayoutParams().height = mProgressBar.getLayoutParams().width = Helper
