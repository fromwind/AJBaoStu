...
public class UpdateManager {
    ...
    public void checkUpdate() {
        if (isUpdate()) {
            ...
            Toast.makeText(mContext, "wugengxin", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void showDownloadDialog() {
        ...
        builder.setButton2("隐藏", new PromptDialog.OnClickListener() {
            @Override
            public void onClick(Dialog dialog, int which) {
                dialog.dismiss();
            }
        ...
        public void run() {
            try {
                ...
                if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                    ...
                    //下载地址
                    URL url = new URL("http://imtt.dd.qq.com/16891/7239599FC1A43B295B4496C6469E054A.apk?fsname=com" +
							".udit.aijiabao_2.0.5_6.apk&csr=4d5s");
                    // 创建连接
                    ...
                    File apkFile = new File(mSavePath, "爱驾宝.apk");
