...
public class RealPracticeActivity extends BaseActivity {
    ...
    RealPracticeAdapter pagerAdapter;
    ...
    public void initView() {
        ...
        if (position > 0) {
            ...
            pagerAdapter = new RealPracticeAdapter(
                    RealPracticeActivity.this, viewItems,
                    dataItems);
