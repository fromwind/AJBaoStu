...
import com.udit.aijiabao.activitys.MyErrorQuestionActivity;
...
public class ExaminationSubmitAdapter extends PagerAdapter {
			...
			holder.layoutA.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(dataItems.get(position).getCorrectAnswer().contains("A")){
						...
						long colunm=insertErrorQuestion(errorQuestionInfo);
	...
	private long insertErrorQuestion(ErrorQuestionInfo errorQuestionInfo) {
		return 0;
	}
