...
public class ImageViewPlus extends ImageView{
	...
	public ImageViewPlus(Context context, AttributeSet attrs) {
		...
		mBorderColor = ta.getColor(R.styleable.ImageViewPlus_borderColor1, DEFAULT_BORDER_COLOR);
		mBorderWidth = ta.getDimensionPixelSize(R.styleable.ImageViewPlus_borderWidth1, dip2px(DEFAULT_BORDER_WIDTH));
